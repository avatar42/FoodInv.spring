...
import com.dea42.foodInv.service.UserServices;
import com.dea42.foodInv.repo.UserRepository;
import com.dea42.foodInv.repo.InvRepository;
import com.dea42.foodInv.service.InvServices;
import com.dea42.foodInv.repo.AccountRepository;
...
public class MockBase extends UnitBase {
    ...
    protected UserRepository userRepository;
     ...
     @MockBean
    protected InvServices invServices;
    @MockBean
    protected InvRepository invRepository;
    @MockBean
    protected AccountServices accountServices;
    @MockBean
    protected AccountRepository accountRepository;
    @MockBean
    protected OrdersServices ordersServices;
    @MockBean
	...
	public void checkHeader(ResultActions result, String user) throws Exception {
		...
		contentContainsKey(result, "class.Inv", false);
		if ("admin@dea42.com".equals(user)) 
			contentContainsKey(result, "class.Account", false);
		contentContainsKey(result, "class.Orders", false);
// REST menu
		contentContainsKey(result, "header.restApi");
		contentContainsMarkup(result, "/api/invs", false);
		if ("admin@dea42.com".equals(user)) 
			contentContainsMarkup(result, "/api/accounts", false);
		contentContainsMarkup(result, "/api/orderss", false);
